...
const AlertSuccess = ({ msg, close }) => {
  return (
    <div id="alert-border-2" className="flex p-4 mb-1 text-green-800 border-t-4 border-green-300 bg-green-50" role="alert">
      ...
      <button onClick={close} type="button" className="ml-auto -mx-1.5 -my-1.5 bg-green-50 text-green-500 rounded-lg focus:ring-2 focus:ring-green-400 p-1.5 hover:bg-green-200 inline-flex h-8 w-8" data-dismiss-target="#alert-border-2" aria-label="Close">
